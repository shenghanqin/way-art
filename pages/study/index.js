    ...
    props: {
      schools: [
        ...
        },
        {
          img: 'school-20-1.png',
          title: '米兰威尔第音乐学院',
          text: '米兰威尔第音乐学院（ Conservatorio Giuseppe Verdi di MILANO），即米兰音乐学院，意大利最大、最重要的音乐学府之一，一百多年来为世界各国培养出了无数优秀的乐队指挥，演奏家，歌唱家和音乐教师。因其优越的地位和他们的教师主要来源于世界上最顶尖级的斯卡拉歌剧院，使这所学校蜚声于世界，每年拥有800多名来自世界各地的学生在这里学习及进修，这里是登入音乐殿堂的必经之路。'
        },
        {
          img: 'school-20-2.png',
          title: '意大利新美术学院',
          text: '米兰新美术学院（Nuova Accademia di Belle Arti Milano）建立与1980年，坐落于历史悠久的Navigli区，是一所具有创新精神的艺术学府，也是富有活力的艺术文化中心。\n米兰新美术学院是第一所受中意两国教育部认证的意大利私立艺术院校。学院开设有艺术类本科，硕士课程以及其他专业课程，设计视觉艺术，设计，时装设计，室内设计，舞台设计等。学院融合教育，研究及实践，意在培养跨学科，多远化的人才。'
        },
        {
          img: 'school-4.png',
          title: '马兰欧尼学院',
          text: '建立于1935年，是世界公认的时尚界最高学府，最著名的设计学院，时装教育最高殿堂，世界设计学院领导者， 世界三大时装学院之一。学院自创校至今，马兰欧尼服装设计学院已为时装界培养了30000 多名专业设计人才，其中包括有Dolce & Gabbana公司的创始人Domenico Dolce和MOSCHINO的创始人Franco Moschino。'
        },
        {
          img: 'school-3.png',
          title: '威尼斯美术学院',
        ...
        },
        {
          img: 'school-20-3.png',
          title: '卢索服装学院',
          text: '卢索服装学院（Accademia del Lusso,简称ADL）创建于2005年，隶属于意大利最大的教育集团CEPU Group，总部位于米兰最具时尚品味的奢华购物街——蒙特拿破仑大街（Via Montenapoleone），是学习时尚与奢侈品管理的绝佳选择，同时，学院也与重大知名时尚企业如Prada，Valentino等建立了合作关系，为学生提供便捷的实习与就业渠道。'
        },
        {
          img: 'school-20-4.png',
          title: '多尼采蒂音乐学院',
          text: '多尼采蒂音乐学院与巴西利亚和马萨特（米兰）市政府于1998年成立，旨在为音乐家和抒情歌手提供完善的课程。它由在音乐和唱歌领域工作的不同组织组成，该课程对所有人开放，尤其是对外国人开放，他们对遵循意大利传统曲目和技巧提高意大利“BelCanto”水平的兴趣。'
        },
